...
\begin{center}
    \textit{The new Lattice Boltzmann method provides a relevant representation of the fluid, enabling real-time visualization of fluid simulations through GPU parallelization.
}
\end{center}
...
\begin{figure}[ht!]
    ...
    \caption{Basic calculation steps of the algorithm, based on the work of Schiller, Ulf and Krüger, Timm and Henrich, and Oliver \cite{algo}}
...
In this way, interactions are local and can be exploited for GPU parallelization: the computation can be divided and distributed to each processing unit of the GPU.
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Real-time visualization of a raindrop with a resolution grid of 3 million cells}
        \label{fig:ex1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Aerodynamic fluid simulation of an F1 car with a resolution of one billion cells}
        \label{fig:ex2}
    \end{subfigure}
